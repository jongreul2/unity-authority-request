"""git clean 필터: ProjectSettings.asset에서 Fusion SDK가 로컬에 추가한 정의(FUSION2, FUSION_WEAVER, FUSION_LOGLEVEL_* 등 FUSION으로 시작하는 것)를 뺀다.
    ...
    while i < len(lines):
        ...
        if line.rstrip() == "  scriptingDefineSymbols:":
            ...
            while i < len(lines) and re.match(r"^    \S", lines[i]):
                ...
                kept = [d for d in value.strip().split(";") if d and not d.startswith("FUSION")]
                if kept:
